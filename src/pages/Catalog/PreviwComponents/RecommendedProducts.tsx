...
export const RecommendedProducts = ({ products, onSelect }: RecomendedProductProps) => {
  ...
  return (
    <div className="overflow-x-auto md:p-2 text-xs col-span-2 flex flex-col justify-start ">
      {productsIsNotEmpty && <h3 className="text-2xl mb-2 pl-2">Схожі товари</h3>}
      <div className="grid grid-cols-2 lg:grid-cols-5 sm:grid-cols-2 gap-2  justify-center">{recomendedProductsToRender}</div>
    </div>
  );
};
