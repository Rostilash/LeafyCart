...
export const ProductRow = ({ product, openEditModal, deleteRow }: renderProductProps) => {
  return (
    <div className="grid grid-cols-[1fr_1fr_50px_50px] md:grid-cols-6 p-4 items-center justify-center border-b">
      <img
        ...
        className="hidden md:block w-18 h-15 rounded-full border-r"
      />
      <h3>{product.name}</h3>
