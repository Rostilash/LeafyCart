...
export const Header: React.FC<HeaderProps> = ({ setIsNavOpend, setIsCartOpen, isNavOpened, quantity }) => {
  ...
  return (
    <header className="row-start-1 row-end-2 col-span-2 bg-[var(--leafy-dark)] p-3.5 shadow-md items-center justify-center text-white">
        ...
        <div className="relative flex justify-around items-center gap-4">
          ...
          <span className="relative cursor-pointer">
            ...
            {quantity !== undefined && quantity > 0 && (
              <span className="absolute -bottom-3 left-5 bg-[var(--leafy-sage)] font-bold  text-black text-xs rounded-full px-1.5 py-0.5 leading-none shadow-md">
                {quantity}
              </span>
            )}
          </span>
