...
export const Sidebar: React.FC<SidebarProps> = ({ isVisible, onClose }) => {
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-screen lg:w-64 bg-white shadow-lg z-50 transition-opacity duration-300 ${
          isVisible ? "opacity-100 visible" : "opacity-0 invisible"
        }`}
      >
        <div>
          <div className="flex items-center p-3 sm:px-8 sm:p-5 text-xl font-bold bg-white">
